...
void AFlightPawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	check(InputComponent);

	// Bind our control axis' to callback functions
	InputComponent->BindAxis("Thrust", this, &AFlightPawn::ThrustInput);
	InputComponent->BindAxis("MoveUp", this, &AFlightPawn::MoveUpInput);
	InputComponent->BindAxis("MoveRight", this, &AFlightPawn::MoveRightInput);
}
